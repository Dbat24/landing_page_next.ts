...
const Footer = () => {
  return (
    <div className="m-0">
      <div className="bg-[#0a023a] text-[#b9b9de] md:flex  md:justify-around md:text-sm items-center md:px-2 px-5 md:mt-1 md:m-0 w-full grid grid-cols-3 gap-3  py-10 mt-1">
